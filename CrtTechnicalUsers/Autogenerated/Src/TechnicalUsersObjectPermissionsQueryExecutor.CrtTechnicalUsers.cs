namespace Terrasoft.Configuration
{
	...
	public class TechnicalUsersObjectPermissionsQueryExecutor : IEntityQueryExecutor
	{
		...
		private Select GetUsersObjectPermissionsSelectQuery(EntitySchemaQueryFilterCollection filters,
				OrderDirectionStrict orderDirection) {
			var selectQuery =
				...
				.OrderBy(orderDirection, "SysSchemaName")
					as Select;
		...
		public EntityCollection GetEntityCollection(EntitySchemaQuery esq) {
			var orderDirectionStrict = esq.Columns?.FindByName("Object")?.OrderDirection == OrderDirection.Descending
                ? OrderDirectionStrict.Descending
                : OrderDirectionStrict.Ascending;
			Select selectQuery = GetUsersObjectPermissionsSelectQuery(esq.Filters, orderDirectionStrict)
