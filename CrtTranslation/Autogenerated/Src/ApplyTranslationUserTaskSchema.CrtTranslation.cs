namespace Terrasoft.Core.Process.Configuration
{
	...
	[DesignModeProperty(Name = "LocalizationPackage", Group = "", ValuesProvider = "ProcessSchemaParameterValueProvider", Editor="xtype=processschemaparametervalueedit;dataProvider=processschemaparametervalueprovider", ResourceManager = "c4599dfdb6cb455eb245b033b4b50ab3", CaptionResourceItem = "Parameters.LocalizationPackage.Caption", DescriptionResourceItem = "Parameters.LocalizationPackage.Caption", UseSolutionStorage = true)]
	/// <exclude/>
	public partial class ApplyTranslationUserTask : ProcessUserTask
	{
		...
		public virtual Guid LocalizationPackage {
			get;
			set;
		}

		private LocalizableString _translationsPackageIsNotWritable;
		public LocalizableString TranslationsPackageIsNotWritable {
			get {
				return _translationsPackageIsNotWritable ?? (_translationsPackageIsNotWritable = new LocalizableString(Storage, Schema.GetResourceManagerName(), "LocalizableStrings.TranslationsPackageIsNotWritable.Value"));
			}
		}
		...
		public override void WritePropertiesData(DataWriter writer) {
			...
			if (!HasMapping("LocalizationPackage")) {
				writer.WriteValue("LocalizationPackage", LocalizationPackage, Guid.Empty);
			}
			writer.WriteFinishObject();
		}
		...
		protected override void ApplyPropertiesDataValues(DataReader reader) {
			...
			switch (reader.CurrentName) {
				...
				break;
				case "LocalizationPackage":
					LocalizationPackage = reader.GetGuidValue();
				break;
			}
		}
