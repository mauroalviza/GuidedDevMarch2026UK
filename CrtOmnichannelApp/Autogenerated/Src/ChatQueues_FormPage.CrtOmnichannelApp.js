		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.NumberInput",
					"label": "$Resources.Strings.ChatQueueDS_FirstResponseTime_zphlpko",
					"control": "$ChatQueueDS_FirstResponseTime_zphlpko",
					"readonly": false,
					"placeholder": "",
					"labelPosition": "auto",
					"tooltip": "#ResourceString(FirstResponseTime_tooltip)#",
					"visible": true
				},
				"parentName": "QueueFieldsContainer",
				"propertyName": "items",
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.NumberInput",
					"label": "$Resources.Strings.ChatQueueDS_OngoingResponseTime_kj9xygb",
					"control": "$ChatQueueDS_OngoingResponseTime_kj9xygb",
					"readonly": false,
					"placeholder": "",
					"labelPosition": "auto",
					"tooltip": "#ResourceString(OngoingResponseTime_tooltip)#",
					"visible": true
				},
				"parentName": "QueueFieldsContainer",
				"propertyName": "items",
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"ChatQueueDS_FirstResponseTime_zphlpko": {
						"modelConfig": {
							"path": "ChatQueueDS.FirstResponseTime"
						}
					},
					"ChatQueueDS_OngoingResponseTime_kj9xygb": {
						"modelConfig": {
							"path": "ChatQueueDS.OngoingResponseTime"
						}
					}
				}
			}
