define("CopilotActions_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Checkbox",
					"control": "$PDS_IsConfirmRequired",
					"disabled": false,
					"inversed": false,
					"visible": "$UseActionConfirmations",
					"label": "#ResourceString(RequireConfirmation_label)#",
					"ariaLabel": "#ResourceString(RequireConfirmation_ariaLabel)#",
					"labelPosition": "right",
					"tooltip": "#ResourceString(RequireConfirmation_tooltip)#"
				},
				"parentName": "ActionSettingsTabControlsContainer",
				"propertyName": "items",
				"index": 4
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"PDS_IsConfirmRequired": {
						"modelConfig": {
							"path": "PDS.IsConfirmRequired"
						}
					},
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
				...
				"handler": async (request, next) => {
					...
					const actionConfirmationFeatureState = await featureService.getFeatureState('GenAIFeatures.UseActionConfirmations');
					await request.$context.set('UseActionConfirmations', actionConfirmationFeatureState);
