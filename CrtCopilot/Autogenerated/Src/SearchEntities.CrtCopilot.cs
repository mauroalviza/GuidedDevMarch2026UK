namespace Terrasoft.Core.Process.Configuration
{
	...
	public partial class SearchEntities
	{
		...
		protected override bool InternalExecute(ProcessExecutingContext context) {
			...
			var userConnectionParam = new ConstructorArgument("userConnection", context.UserConnection);
			var globalSearchService = ClassFactory.Get<GlobalSearchService>(userConnectionParam);
