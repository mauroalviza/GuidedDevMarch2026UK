namespace Terrasoft.Core.Process.Configuration
{
	...
	[DesignModeProperty(Name = "CopilotSessionId", Group = "", ValuesProvider = "ProcessSchemaParameterValueProvider", Editor="xtype=processschemaparametervalueedit;dataProvider=processschemaparametervalueprovider", ResourceManager = "d5dd65c4238a454181b20445a1fb3f91", CaptionResourceItem = "Parameters.CopilotSessionId.Caption", DescriptionResourceItem = "Parameters.CopilotSessionId.Caption", UseSolutionStorage = true)]
	[DesignModeProperty(Name = "CopilotRootSessionId", Group = "", ValuesProvider = "ProcessSchemaParameterValueProvider", Editor="xtype=processschemaparametervalueedit;dataProvider=processschemaparametervalueprovider", ResourceManager = "d5dd65c4238a454181b20445a1fb3f91", CaptionResourceItem = "Parameters.CopilotRootSessionId.Caption", DescriptionResourceItem = "Parameters.CopilotRootSessionId.Caption", UseSolutionStorage = true)]
	/// <exclude/>
	public partial class ExecuteIntentUserTask : ProcessUserTask
	{
		...
		public virtual Guid CopilotSessionId {
			get;
			set;
		}

		public virtual Guid CopilotRootSessionId {
			get;
			set;
		}
		...
		public override void WritePropertiesData(DataWriter writer) {
			...
			if (!HasMapping("CopilotSessionId")) {
				writer.WriteValue("CopilotSessionId", CopilotSessionId, Guid.Empty);
			}
			if (!HasMapping("CopilotRootSessionId")) {
				writer.WriteValue("CopilotRootSessionId", CopilotRootSessionId, Guid.Empty);
			}
			writer.WriteFinishObject();
		}
		...
		protected override void ApplyPropertiesDataValues(DataReader reader) {
			...
			switch (reader.CurrentName) {
				...
				case "CopilotSessionId":
					CopilotSessionId = reader.GetGuidValue();
				break;
				case "CopilotRootSessionId":
					CopilotRootSessionId = reader.GetGuidValue();
				break;
			}
		}
