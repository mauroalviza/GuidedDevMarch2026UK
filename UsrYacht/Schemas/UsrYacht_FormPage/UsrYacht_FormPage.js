		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.ComboBox",
					"label": "$Resources.Strings.PDS_UsrCaptain_8279m3p",
					"ariaLabel": "",
					"isAddAllowed": true,
					...
					"listActions": [],
					"tooltip": "",
					"control": "$PDS_UsrCaptain_8279m3p",
					"visible": true,
					"readonly": false,
					"placeholder": "",
					"valueDetails": null
			...
			{
				"operation": "insert",
				"name": "addRecord_t4ec298",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_t4ec298_caption)#",
					"clicked": {
			...
			},
			{
				...
				"values": {
					...
					"label": "$Resources.Strings.PDS_UsrLength_934d7or",
					"control": "$PDS_UsrLength_934d7or",
					"readonly": false,
					"placeholder": "",
					"labelPosition": "auto",
					"tooltip": ""
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.NumberInput",
					"label": "$Resources.Strings.PDS_UsrCrewCount_v1s7sxd",
					"control": "$PDS_UsrCrewCount_v1s7sxd",
					"readonly": false,
					"placeholder": "",
					"labelPosition": "auto",
					"tooltip": ""
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(AddRentalRecords_caption)#",
					"color": "default",
					"disabled": false,
					"size": "large",
					...
					"clicked": {
						"request": "crt.RunBusinessProcessRequest",
						"params": {
							"processName": "UsrAddRentalRecords",
							"processRunType": "ForTheSelectedPage",
							"saveAtProcessStart": true,
							"showNotification": true,
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"PDS_UsrLength_934d7or": {
						"modelConfig": {
							"path": "PDS.UsrLength"
						}
					},
					"PDS_UsrCrewCount_v1s7sxd": {
						"modelConfig": {
							"path": "PDS.UsrCrewCount"
						}
					},
					"PDS_UsrCaptain_8279m3p": {
						"modelConfig": {
							"path": "PDS.UsrCaptain"
						}
					},
					"PDS_UsrCaptain_8279m3p_List": {
						"isCollection": true,
						"modelConfig": {
							"sortingConfig": {
								"default": [
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrDriveType_nehkj0f;
