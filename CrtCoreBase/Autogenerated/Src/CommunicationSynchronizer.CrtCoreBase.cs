namespace Terrasoft.Configuration
{
	...
	public class CommunicationSynchronizer {
		...
		private string GetLinkedColumnName(string entitySchemaName) {
			...
			if (!CheckCommunicationObjectExists()) {
		...
		private bool CheckCommunicationObjectExists() {
			return UserConnection.EntitySchemaManager.FindInstanceByName(CommunicationEntityName) != null;
		}
