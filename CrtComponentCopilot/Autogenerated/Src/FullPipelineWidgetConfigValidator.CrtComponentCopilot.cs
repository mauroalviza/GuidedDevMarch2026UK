 namespace Creatio.ComponentCopilot
{
    ...
    [DefaultBinding(typeof(IViewElementConfigValidator), Name = "FullPipelineWidgetConfigJsonSchemaValidator")]
    public class FullPipelineWidgetConfigValidator : IViewElementConfigValidator
    {
        ...
        public IList<string> Validate(string configJson) {
            ...
            try {
	            ...
	            ValidateFilters("Lead", config["element"]["leadsFilters"], errors);
